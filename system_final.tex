...
\begin{figure}[t]
  ...
  \tightcaption{Interfaces of \name's centralized control.\jc{please add the step of network monitor. see the new text}}
% \jc{where are servers? avoid notions never defined before like "task announcement"}
