...
%
\NEW{
A further development, \newname, addresses the real-time dynamic bandwidth separation problem by predicting the bandwidth utilization of online traffic and enabling a novel incremental scheduling strategy.
}
...
\NEW{
\item Presenting \newname, the advanced version of \name that can work collaboratively with dynamic online traffic by making real-time dynamic bandwidth separations
