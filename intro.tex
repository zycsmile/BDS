...
sends them in parallel via bottleneck-disjoint overlay paths with dynamic bandwidth adjustment.} These
...
\name \NEW{with fixed bandwidth separation (be fair to the existing solutions)} in 10 DCs and ran a pilot study on 500~TB of data transfer
