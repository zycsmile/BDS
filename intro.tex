...
\NEW{
\newname address the real-time dynamic bandwidth separation problem by predicting the bandwidth utilization of online traffic and enabling a novel incremental scheduling strategy.
}
