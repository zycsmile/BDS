...
predict online traffic and adjust the available bandwidth for offline bulk data transfer. Two-fold: make full use of idle bandwidth when online traffic is in valley, avoidance when online traffic bursts.
}
