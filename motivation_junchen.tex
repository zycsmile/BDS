...
application-level overlays~\cite{end-system-multicast}.
...
%<<<<<<< HEAD
\mypara{Inter-DC path diversity in the wild}
We argue that the benefits illustrated in the example of
Figure~\ref{fig:case:example} can actually be realized in a
