...
compared with the ideal completion time. \jc{Change this graph to CDF}}
  \label{fig:motivation}
\vspace{-0.4cm}
\end{figure}
...
\begin{figure}[t]
        ...
        \caption{Bulk data transfer on the 2nd day caused obviously irregular traffic.\jc{legend is missing. what's green line, what's blue line, what's the red line? text font in the picture is way too small}}
        \label{fig:lesson2}
%\vspace{0.1in}
\end{figure}
