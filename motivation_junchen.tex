...
\label{table:rate}
\end{table}
\myfootnotetext{The overall multicast traffic
...
\jc{these measurements were collected at the same time? could this variance be simply noise?}
...
The existing decentralized protocol lacks the global view, and thus cannot make optimal scheduling.
...
\begin{figure}[t]
  ...
  \vspace{-0.2cm}
  \tightcaption{CDF of the actual flow completion time at servers in the destination DCs,
compared with the ideal solution. }
  \label{fig:motivation}
\vspace{-0.4cm}
\end{figure}
...
\begin{figure}[t!]
        ...
        \tightcaption{The utilization of the inter-DC link in two days. Bulk data transfer on the 2nd day caused obviously irregular outgoing traffic.}
        \label{fig:lesson2}
\vspace{-0.1in}
\end{figure}
