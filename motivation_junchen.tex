...
\begin{figure}[t]
	...
	\hspace{0.1cm}
        \begin{subfigure}[b]{0.23\textwidth}
                ...
                \label{fig:bulk:size}
        \end{subfigure}
        \tightcaption{Inter-DC multicast data transfers are (a) destined to a significant
...
is typically several Gb/s, \jc{is it correct?}
...
minutes.\jc{I'm lost. What's a block? Are you assuming 
the file is evenly spread across all 64 servers? Is that what happened
in reality?}
