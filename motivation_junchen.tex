...
days. The blue line denotes the outgoing (outbound) bandwidth and the green line denotes the ingoing (inbound) bandwidth. \jc{please put the legend in the figure} 
...
\begin{figure}[t!]
        ...
        \tightcaption{Bulk data transfer on the 2nd day caused obviously irregular traffic.\jc{legend is missing. what's green line, what's blue line, what's the red line? text font in the picture is way too small}}
        \label{fig:lesson2}
\vspace{-0.1in}
\end{figure}
