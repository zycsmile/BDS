...
fraction of DCs, and (2) huge in volume.\jc{in (a), why 80\% bar is higher than 60\%? please use the same color in (b). also please change y-axis to "\% of data transfers". "frac of apps" sounds weird. Also, the y-axis tics are too crowded.}}
        \label{fig:bulk}
\vspace{-0.4cm}
\end{figure}
...
\caption{
Measurements showing the potential bandwidth between different (s,d) pairs.
...
\begin{figure}[t]
        ...
        \caption{Bulk data transfer on the 2nd day caused obvious irregular traffic.}
        \label{fig:lesson2}
%\vspace{0.1in}
\end{figure}
...
\jc{can you say something like such inefficiency is due to
the inability to explore the whole decision space without a
global view?}
...
from about $15ms$ to nearly $500ms$.
