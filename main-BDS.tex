...
\input{motivation_journal}

%\input{overview}
%\input{overview_junchen}
%\input{overview_new}
\input{overview_journal}
...
\input{dynamic_journal}

%\input{system}
\input{system_journal}
%
%\input{impl}
\input{impl_journal}
%
