...
\title{\newname: A Centralized Near-Optimal Overlay Network with Dynamic Bandwidth Separation}
...
\author{Yuchao~Zhang*,~\IEEEmembership{Member,~IEEE,}
        ...
        and~Haiyang~Wang,~\IEEEmembership{Member,~IEEE}% <-this % stops a space
...
\IEEEcompsocthanksitem Guang Yao and Miao Zhang are with Baidu Company, Beijing, China.\protect\\
...
\thanks{Corresponding author: Yuchao Zhang, Wendong Wang and Ke Xu.}
