...
\newcommand{\jc}[1]{{\footnotesize\color{black}{[JC: #1]}}}
...
\minor{
\title{\name: An Inter-Datacenter Data Replication System with Dynamic Bandwidth Separation}
}

\author{Yuchao~Zhang*\textsuperscript{\Letter},~\IEEEmembership{Member,~IEEE,}
        Xiaohui~Nie*,~\IEEEmembership{Member,~IEEE,}
        Junchen~Jiang,~\IEEEmembership{Member,~IEEE,}\\
        Wendong~Wang,~\IEEEmembership{Senior Member,~IEEE,}
        Ke~Xu,~\IEEEmembership{Senior Member,~IEEE,}\\
        Youjian~Zhao,~\IEEEmembership{Senior Member,~IEEE,}
        Martin~J.~Reed,~\IEEEmembership{Member,~IEEE,}\\
        Kai~Chen,~\IEEEmembership{Senior Member,~IEEE,}
        Haiyang~Wang,~\IEEEmembership{Member,~IEEE,}
        and~Guang~Yao%,
        %and~Miao~Zhang% <-this % stops a space
\IEEEcompsocitemizethanks{\IEEEcompsocthanksitem Yuchao Zhang and Wendong Wang are with the School of Computer Science (National Pilot Software Engineering School) at the Beijing University of Posts and Telecommunications. Wendong Wang is also with the State Key Laboratory of Networking and Switching Technology at the Beijing University of Posts and Telecommunications. Beijing, China. %\protect\\
E-mail: yczhang@bupt.edu.cn, wdwang@bupt.edu.cn
\IEEEcompsocthanksitem Xiaohui Nie, Ke Xu and Youjian Zhao are with Tsinghua University, Beijing, China. Ke Xu is also with BNRist and Peng Cheng Laboratory. %\protect\\
E-mail: niexiaohui@mail.tsinghua.edu.cn, xuke@tsinghua.edu.cn, zhaoyoujian@tsinghua.edu.cn
...
\thanks{*Yuchao Zhang and Xiaohui Nie contribute equally to this paper.}
\thanks{\textsuperscript{\Letter}Corresponding Author: Yuchao Zhang, yczhang@bupt.edu.cn}
% Yuchao Zhang and Xiaohui Nie contribute equally to this paper.
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{images/zyc.pdf}}]
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{images/xu.pdf}}]{Ke Xu} (M'02-SM'09) received his Ph.D. from the Department of Computer Science and Technology of Tsinghua University, where he serves as full professor. He serves as Associate Editor of IEEE Internet of Things Journal and has guest edited several special issues in IEEE and Springer Journals. His research interests include next generation Internet, P2P systems, Internet of Things, network virtualization, and network economics. He is a member of ACM.
\end{IEEEbiography}
