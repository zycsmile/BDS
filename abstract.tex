...
One of the most common inter-DC  communication patterns
...
the disjoint inter-DC paths that exist in abundance.
...
(1) the sheer numbers of servers and overlay paths 
which render it untenable to make optimal overlay selections 
in real-time, and (2) a strict requirement to prevent delays of 
