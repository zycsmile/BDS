...
In summary, both the prototype pilot deployed on \company network and the trace-driven simulations of \name achieve 3 to 5 times speedup over existing solutions, with good scalability, strong adaptability and near-optimal scheduling results.
