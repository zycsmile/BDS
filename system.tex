...
\jc{refreshes every \fillme seconds?}, and dynamically 
...
\jc{not sure the logic flows. use this folow instead: (1) bds's app-level bandwidth allocation is complemtary to QoS solutions, (2) bds uses global coordination to achieve more efficient bandwidth utilization}
