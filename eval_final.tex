...
distribut 70~TB data from a source DC to \jc{how many?} DCs.
Figure~\ref{fig:BDSvsAnon:overall} shows the cumulative distribution 
function (CDF) of the completion time on each destination DC \jc{do you have enough dst DCs to plot the smooth CDF?}. We can
...
1000 servers. The rate-limited setup is the same as the baseline setup\jc{right?}, 
