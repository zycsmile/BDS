...
We have deployed \name on \company's DCs, which consist of 67 servers in 10 IDCs located in three major regions in China. The topology is shown as figure \ref{fig:topology}. Evaluations in the next section are based on this deployment.
