...
\begin{figure}[t]
  ...
  \caption{The centralized design of \name.\jc{push ``what decision''? pull ``what information''? please use a server-shape png, not circles. also, does that cloud-shape thing a datacenter? if so, please write it down.}}
  \label{fig:framework}
\vspace{-0.4cm}
\end{figure}
